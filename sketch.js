...
function preload()
{
  ...
  doubleStar = loadImage("stars.png")
...
function setup() 
{
 ...
 // bk_song.setVolume(0.5);
  ...
  starScore = createSprite(60,50)
  starScore.addImage("Empty",emptyStars)
  starScore.scale = 0.2
  starScore.addImage("OneStar",oneStar)
  starScore.addImage("TwoStar",doubleStar)
